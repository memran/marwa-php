...
- `app.php` - application identity, providers, middleware stack, debugbar collectors, and starter maintenance / 404 / 500 template references
...
- `view.php` - framework view paths, cache, theme defaults, and the starter admin theme override
