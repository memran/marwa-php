...
- `config/` starter overrides for app identity, console discovery, and theme names
...
- `config/view.php` defines the frontend and admin theme names
...
5. `config/` for starter-specific defaults
